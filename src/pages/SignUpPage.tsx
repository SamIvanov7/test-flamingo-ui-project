...
import { Mail, Lock, Eye, EyeOff, Check, X, User, UserPlus } from 'lucide-react'
...
export default function SignUpPage() {
  ...
  const strengthColors = ['bg-red-500', 'bg-orange-500', 'bg-yellow-500', 'bg-limeGreen']
    ...
    >
      ...
      >
        <div className="glassmorphism rounded-3xl p-8">
          ...
          >
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-pink/20 mb-4">
              <UserPlus className="w-10 h-10 text-pink" />
            </div>
            <h1 className="text-3xl font-bold mb-2">
              <span className="text-limeGreen">Join</span>{' '}
              <span className="text-pink">The Revolution</span>
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-beigeCream/50" />
                <input
                  type="text"
                  name="fullName"
              ...
              {formData.password && (
                <div className="mt-2">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs text-beigeCream/50">Password strength:</span>
                    <span className="text-xs text-beigeCream/70">
            ...
            <div>
              <label className="flex items-start space-x-2 cursor-pointer">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4 h-4 mt-0.5 bg-white/10 border border-white/20 rounded focus:ring-2 focus:ring-limeGreen/50"
                />
                <span className="text-beigeCream/70 text-sm">
                  I agree to the{' '}
                  <Link to="/terms" className="text-pink hover:text-pink/80 transition-colors">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy" className="text-pink hover:text-pink/80 transition-colors">
                    Privacy Policy
                  </Link>
                </span>
              </label>
              ...
              className={`w-full py-4 font-bold rounded-xl transition-all duration-300
                       flex items-center justify-center space-x-2 ${
                         formStatus === 'success' 
                           ...
                           : 'bg-pink text-white hover:shadow-[0_0_30px_rgba(229,159,206,0.5)]'
                       }`}
            >
              {formStatus === 'submitting' && (
                <>
              ...
              {formStatus === 'idle' && <span>Create Account</span>}
            </motion.button>
          </form>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-transparent text-beigeCream/50">Or sign up with</span>
              </div>
            </div>
